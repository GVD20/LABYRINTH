...
**LABYRINTH** 是一款由大语言模型（LLM）驱动的侧向思维（Lateral Thinking）解谜游戏（海龟汤）。玩家需要通过不断的提问和推理，揭开一个个神秘故事背后的真相。
...
⚠️如果**裁判模型 (Chat)**的参数量较小，建议使用带有Thinking模式的模型，以提高准确度。
